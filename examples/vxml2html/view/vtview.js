if(typeof (VTView) != 'object')
{
    ...
    VTView.transform=function(cxvm,templateUrl,cbResult)  
    {
          ...
          XTemplate.setErrorFunction (_errorOut);	
          //XTemplate.setMergeUrlFunction (_mergeUrl);	
          //XTemplate.setEvalFunction (eval);	
          //XTemplate.setEvalUrlFunction (_evalFile);	
          XTemplate.setTextWriterFunction(_write);   	
          XTemplate.setFileReaderFunction(_readText);
          ...
          {			
                ...
                if(status == 'success' )				
                {
                    ...
                    try{
					   XTemplate.Args.cxvm = cxvm;
					   
                       XTemplate.render(text);
